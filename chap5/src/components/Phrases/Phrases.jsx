...
class Phrases extends Component {
    ...
    handleEditElement = (key, phrase, author) => {
        this.setState({ editKey: key, phrase, author });
    };
    ...
    handleUpdatePhrase = () => {
        if (this.state.phrase && this.state.author) {
            ...
            this.setState({ phrase: '', author: '', editKey: false });
        }
    };
            ...
            <div className="phrases">
                ...
                {phrases && phrases.map(({ key, phrase, author }) => (
                    <blockquote key={key} className="phrase">
                        ...
                        <a
                            onClick={() => { this.handleDeleteElement(key); }}
                        >
                            X
                        </a>
                        <a
                            onClick={ () => this.handleEditElement(key, phrase, author) }
                        >
                            Edit
                        </a>
                    </blockquote>
